...
export const privateRoutes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import('../Pages/Profile/add-user-in-comission/add-user-in-comission.component').then((m) => m.AddUserInComissionComponent),
      },
      {
        path: 'transactions',
        canActivate: [canActivateAuth],
      ...
      },
      {
        ...
        canActivate: [canActivateAuth],
        loadComponent: () =>
          import('../Pages/Profile/transactions/transaction-details/transaction-details.component').then((m) => m.TransactionDetailsComponent),
      },
      {
        path: 'online-payment-request',
        canActivate: [canActivateAuth],
        loadComponent: () =>
          import('../Pages/online-payment-request-page/online-payment-request-page.component').then((m) => m.OnlinePaymentRequestPageComponent),
      },
    ],
  },
