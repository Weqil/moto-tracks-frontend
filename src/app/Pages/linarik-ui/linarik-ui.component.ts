...
export class LinarikUiComponent implements OnInit {
  ...
  scrollContainerDown(event: MouseEvent, container: HTMLDivElement) {
    console.log(event)
    container.style.cursor = 'grabbing'
  }
  scrollContainerMove(event: MouseEvent, container: HTMLDivElement) {
    console.log('move')
    console.log(event)
    
  }
  scrollContainerUp(event: MouseEvent, container: HTMLDivElement) {
    console.log('up')
    console.log(event)
